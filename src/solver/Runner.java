...
public class Runner {
	...
	public static int DEFAULT_NUM_SIMULATIONS = 20;
	...
	public static void main(String[] args) throws Exception {
		...
		for (int simNo = 0; simNo < numSimulations; simNo++) {
			...
			totalIterations += ((MySolver) solver).iterations;
			System.out.printf("Number of iterations: %d\n", ((MySolver) solver).iterations);
		...
		System.out.println();
		System.out.printf("Average profit: %f\n", totalProfit/numSimulations);
		System.out.println();
